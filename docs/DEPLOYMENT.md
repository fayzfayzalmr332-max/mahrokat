...
> الملف الوحيد المطلوب: `migrations/master_schema.sql` (≈765 سطراً — دمج مطهَّر لـ 001→006).
...
- افتح `migrations/master_schema.sql` محلياً، وانسخ **كامل** محتواه (Ctrl+A ثم Ctrl+C)
